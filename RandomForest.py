# -*- coding: utf-8 -*-
"""
Created on Thu Mar 25 12:09:40 2021
...
conf_mat = metrics.confusion_matrix(y_test,forest_predict)

print(metrics.classification_report(y_test, forest_predict))
accuracy = metrics.accuracy_score(y_test, forest_predict)
average_accuracy = np.mean(y_test ==forest_predict) * 100
